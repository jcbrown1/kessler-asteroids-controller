...
from controllers.old_simple_fuzzy import OldSimpleFuzzy
...
def run_game():
    ...
    score, perf_data = game.run(scenario=my_test_scenario, controllers = [SimpleFuzzy(), OldSimpleFuzzy()])
...
def test_average_scores(num_games=5):
    ...
    print("Metric : Our Simple vs Old Simple Controller")
